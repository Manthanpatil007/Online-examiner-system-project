...
<div id="developers" class="container-fluid text-center bg-grey">
  ...
  <div class="row text-center slideanim">
    ...
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="man.jpeg" alt="VIJAY" width="300px" height="300px">
        <p style="font-size : 20px"><strong>Manthan Patil</strong></p>
        <p>4th year BE_IT</p>
      </div>
    </div>
    <div class="col-sm-4">
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <p><span class="glyphicon glyphicon-map-marker"></span> karjat, INDIA</p>
      <p><span class="glyphicon glyphicon-phone"></span> +91 8356050526 </p>
      <p><span class="glyphicon glyphicon-envelope"></span> avus@gmail.com</p>
    </div>
